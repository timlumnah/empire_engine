...
function LevelMaker.createMap(level)
    ...
    -- flag to ensure only one locked brick is placed
    ...
    for y = 1, numRows do
        ...
        for x = 1, numCols do
            ...
            -- ====================== TIM LUMNAH'S EDITS ======================
            -- randomly place locked brick if not yet placed
            if not lockedBrickPlaced and math.random() < 0.1 then
                b.isLocked = true
                b.skin = gFrames['locked']
                b.tier = 0      -- set tier to 0 again just in case it was overwritten above
    ...
    if #bricks == 0 then
        ...
        return bricks, lockedBrickPlaced
    end
end
