--[[
    ...
    Represents a single doorway on a room wall. Tracks open/locked
    state, renders the arch graphic, handles NPC unlock animations,
    and exposes the passage trigger bounds for player transitions.
]]
...
function Doorway:init(direction, open, room)
    ...
    -- doorways will always be in the same place so we hard-code their locations
