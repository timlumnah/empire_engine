...
--[[
   ...
   Animation frame sequences and walk-speed definitions for every
   entity type: player, dude, dudette, banker, and competitor. Maps
   directional states to sprite frame arrays and per-direction timing.
]]
-- ====================================================================
