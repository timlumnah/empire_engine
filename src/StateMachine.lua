...
--[[
   ...
   Generic finite state machine used by entities and the global game
   loop. Holds a map of named state constructor functions; change()
   exits the current state, instantiates the new one, and calls
   enter() with optional transition parameters.
]]
-- ====================================================================
